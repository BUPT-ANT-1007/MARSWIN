...
class ModelPlain(ModelBase):
    ...
    def optimize_parameters(self, current_step):
        ...
        #lpips = LPIPSLoss().to(self.device)

        G_loss = self.G_lossfn_weight * self.G_lossfn(self.E, self.H) + self.alignment_loss1 + self.alignment_loss2
        #print(self.G_lossfn(self.x_l1,self.F_r2l1),self.G_lossfn(self.x_l2,self.F_r2l2))
        G_loss.backward()
